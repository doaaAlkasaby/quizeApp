...
class MapViewController2: UIViewController ,CLLocationManagerDelegate,MKMapViewDelegate {
   ...
   // @IBOutlet weak var lable: UILabel!
    ...
    func addLongPressGesture(){
        let longPressRecogniser:UILongPressGestureRecognizer = UILongPressGestureRecognizer(target:self , action:#selector(MapViewController2.handleLongPress))
    ...
    @IBAction func getMyLocation(_ sender: UIButton) {
        ...
        if CLLocationManager.locationServicesEnabled() {
            ...
            MapViewController2.enable = !MapViewController2.enable
        }
    }
